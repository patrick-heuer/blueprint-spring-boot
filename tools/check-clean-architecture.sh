...
readonly SRC_PATH="src/main/java/de/germanedge/edgeone/demo"

readonly DOMAIN_PACKAGE_PATH="${SRC_PATH}/entities"
...
readonly UNAUTHORIZED_PACKAGES_USAGE_IN_DOMAIN="${UNAUTHORIZED_PACKAGES_USAGE_IN_USE_CASES}|use_cases|springframework"
